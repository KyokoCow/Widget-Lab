...
final dividerDefinition = WidgetDefinition(
  id: 'divider',
  title: 'Divider',
  category: 'Display',
  ...
  description: '水平の区切り線を表示するWidget',
    ...
    previewBuilder: (values) {
      ...
      final color = Color(
        (values['color'] as num?)?.toInt() ?? 0xFFBDBDBD,
      );
  ...
  touchParams: [
    ...
    params: [
      ...
      nullable: true,
      description: 'Divider全体の高さ（上下の余白を含む領域）',
    ),
